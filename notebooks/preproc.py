...
#    plot_raw = raw.plot(color = 'blue', scalings= 'auto',duration =10 ,start = 8, title = "Raw EEG signals", show_scalebars=True, show_scrollbars=True)
...
def epochs_gen(filt_raw, event_id = dict(NT = 1, T = 2), tmin = -0.2, tmax = 0.8, picks = 'eeg'):
    ...
    epochs = mne.Epochs(filt_raw, events, event_id, tmin, tmax,
